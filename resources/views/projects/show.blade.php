...
<ul class="nav nav-tabs mb-4">
    <li class="nav-item">
        <a
            class="nav-link {{ $tab === 'summary' ? 'active' : '' }}"
...
<li class="nav-item">
    <a
        class="nav-link {{ $tab === 'source' ? 'active' : '' }}"
...
<li class="nav-item">
    <a
        class="nav-link {{ $tab === 'script' ? 'active' : '' }}"
...
<li class="nav-item">
    <a
        class="nav-link {{ $tab === 'storyboard' ? 'active' : '' }}"
...
<li class="nav-item">
    <a
        class="nav-link {{ $tab === 'youtube' ? 'active' : '' }}"
...
<li class="nav-item">
    <a
        class="nav-link {{ $tab === 'images' ? 'active' : '' }}"
    ...
    <div class="col-xl-4">
        ...
        <div class="card p-4 sticky-actions">
            ...
            <div class="small text-secondary">
                Los proveedores activos son Fake.
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div>
        ...
        <div class="text-secondary small">
            {{ $scenes->count() }} escenas · Arrastra para reordenar
        </div>
    </div>
...
>
    ...
    @forelse($scenes as $scene)
        ...
        >
                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    >
                        ...
                        <button class="btn btn-sm btn-outline-primary">
                            {{ $scene->image_path ? 'Regenerar imagen' : 'Generar imagen' }}
                        </button>
                    </form>
            ...
            <div class="mb-3">
                ...
                <div class="small bg-light rounded p-2 mt-1">
                    {{ $scene->image_prompt }}
                </div>
    ...
    @empty
        ...
        <div class="card p-5 text-center text-secondary">
            Genera el storyboard para crear escenas.
        </div>
