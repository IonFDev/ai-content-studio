...
class ProjectActionController extends Controller
{
    public function transcribe(
        ...
        try {
            ...
            return back()->with(
                'error',
                'No se pudo transcribir: ' . $e->getMessage()
            );
        }
    }
    ...
    public function generateContent(
        ...
        GenerateContentJob::dispatchSync($project->id);
    ...
    public function generateAllImages(
        ...
        GenerateAllImagesJob::dispatchSync($project->id);
    ...
    public function generateImage(
        ...
        GenerateSceneImageJob::dispatchSync($scene->id);

        return back()->with(
            'success',
            sprintf(
                'Imagen de la escena %02d regenerada.',
                $scene->order
            )
        );
    }
    ...
    public function updateYoutube(
        ...
        $data['youtube_keywords'] = $this->splitList(
            $data['youtube_keywords'] ?? ''
        );

        $data['youtube_hashtags'] = $this->splitList(
            $data['youtube_hashtags'] ?? ''
        );
    ...
    public function reorder(
        ...
        return redirect()
            ...
            ->with(
                'success',
                'Orden de escenas actualizado.'
            );
    }

    public function productionGuide(Project $project)
    {
